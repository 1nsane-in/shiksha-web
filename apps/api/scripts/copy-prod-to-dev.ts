...
async function main() {
  ...
  try {
    ...
    try {
      ...
      await insertRelated('UniversityContent', contRows.rows, ['id', 'universityId', 'shortDescription', 'longDescription', 'highlights', 'whyChooseUs', 'gallery', 'videoTour', 'virtualTour'], { highlights: 'TEXT[]', gallery: 'TEXT[]' });
