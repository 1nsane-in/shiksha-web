...
// Local copy for frontend consumption (sync with packages/shared-types/src/bank-config.ts)
...
export const BANK_CONFIGS: Record<string, CountryBankConfig> = {
  ...
  KG: {
    ...
    fields: [
      { name: 'beneficiaryName',    label: 'Beneficiary Name',       placeholder: 'Full legal name',                                   required: true, type: 'text' },
