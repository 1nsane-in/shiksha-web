  ...
  return (
    <Card className="p-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className=" w-full border border-gray-200/80 bg-gray-50/50 p-0.5 rounded-lg">
          <TabsTrigger
            value="invite-link"
            className="flex items-center gap-1.5 flex-1 py-1.5 data-active:border data-active:border-gray-200 data-active:shadow-sm data-active:bg-white rounded-md text-xs"
          >
            ...
            <div className="flex flex-col items-center gap-3 pt-4 text-center">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Share this link with your parent so they can create an account
                  and get linked automatically.
                </p>
              </div>
              <Button
                variant="default"
            ...
            <>
              ...
              <div className="flex flex-wrap gap-2">
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    handleCopy(inviteLink.inviteUrl, "invite-link")
                  }
                >
              ...
              <div className="space-y-2 text-xs text-gray-500">
                ...
                <div className="flex items-center gap-1.5">
                  <Link className="w-3.5 h-3.5" />
                  <span>
                    One-time use — parent will be auto-linked on signup
                  </span>
                </div>
              </div>
            ...
            <>
              ...
              <div className="flex justify-center gap-2">
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    handleCopy(familyCodeData?.familyCode ?? "", "family-code")
                  }
                >
              ...
              <div className="text-center text-xs text-gray-500 space-y-1">
                <p>
                  Share this code with your parent. They can enter it during
                  signup to get linked automatically.
                </p>
                <p>
                  The code doesn't expire unless you regenerate it. Multiple
                  parents can use the same code.
                </p>
              </div>
            </>
          )}
