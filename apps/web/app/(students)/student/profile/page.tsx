  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <Badge
          variant={
            stageInfo?.applicationStatus === "APPROVED"
              ? "default"
              : "secondary"
          }
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 pt-1.5">
                      ...
                      {recentActivity.find(
                        (e) => e.stage === stageNum && e.isCompleted,
                      ) && (
                      ...
                      {stageNum === currentStage && (
                        <p className="text-xs text-[#4B2D8E] mt-1 font-medium">
                          In Progress
                        </p>
                      )}
                    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {currentStage === 1 && (
          <Card
            size="sm"
            className="border-[#4B2D8E]/20 bg-gradient-to-br from-white to-[#F0A030]/5"
          >
          ...
          {appsLoading ? (
            <div className="space-y-3">
              {Array.from({ length: 2 }).map((_, i) => (
                <Skeleton key={`app-skel-${i}`} className="h-16 w-full" />
              ))}
            </div>
              ...
              {[...applications]
                ...
                .map((app) => (
                  <button
                    key={app.id}
                    type="button"
                    className="flex w-full items-center gap-3 rounded-lg p-3 hover:bg-[#F8F6FC] transition-colors cursor-pointer text-left"
                    onClick={() =>
